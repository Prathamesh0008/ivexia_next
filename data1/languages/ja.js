...
hero: [
  {
    eyebrow: "グローバル展開",
    title: "国際パートナー向けの信頼できる医薬品供給",
    text: "調達から実行まで、輸入業者をサポートします。",
    cta: "お問い合わせ",
    secondaryCta: "サービスを見る",
    spotlight: "輸出対応生産。",
    stats: [
      { value: "GMP", label: "品質管理" },
      { value: "Global", label: "市場対応" },
      { value: "Docs", label: "規制サポート" }
    ]
  },
  {
    eyebrow: "研究から拡大へ",
    ...
    spotlight: "国際供給体制。",
    stats: [
      { value: "API", label: "原料供給" },
      { value: "OEM", label: "OEM" },
      { value: "QA", label: "コンプライアンス" }
    ]
  },
  {
    eyebrow: "市場対応",
    title: "OTC・API・製剤サポート",
    text: "市場参入のための総合ソリューション。",
    cta: "折り返し依頼",
    secondaryCta: "テストキット",
    spotlight: "市場対応製品。",
    stats: [
...
accordSection: {
  ...
  regions: {
    asia: {
      label: "アジア",
      paragraphs: [
        "好ましい規制の動向により、多くのアジア諸国が世界市場に統合され、高度なヘルスケアソリューションへの需要が加速しています。",
        "東アジア、ASEAN、南アジア市場では、低所得および中所得層向けに調整された手頃な価格の製品でアクセスを拡大し続けています。"
      ]
    },
    africa: {
      label: "アフリカ",
      paragraphs: [
        "焦点を絞った地域戦略と専任の開発実行により、アフリカ地域全体での市場適応が強化され続けています。",
        "西アフリカ、北アフリカ、東アフリカ、南部アフリカにわたる強力な流通ネットワークにより、大規模市場と新興市場の両方で一貫した成長を維持しています。"
      ]
    },
    "north-america": {
      label: "北米",
      paragraphs: [
        "高いイノベーションの成熟度と堅牢なヘルスケアインフラにより、北米はプレミアムおよびスペシャルティ製品にとって重要な市場となっています。",
        "当社のモデルは、規制への対応力と強力なチャネルパートナーシップを重視し、米国、カナダおよび近隣市場での一貫した規模拡大をサポートします。"
      ]
    },
    "latin-america": {
      label: "ラテンアメリカ",
      paragraphs: [
        "ラテンアメリカは、確立された市場と急速に成長している市場が混在する高い可能性を秘めており、ローカライズされた戦略が長期的な成長を促進します。",
        "メキシコから南米南部諸国まで、国別の適応により、質の高い費用対効果の高いヘルスケアソリューションを迅速に提供しています。"
      ]
    },
    "middle-east": {
      label: "中東",
      paragraphs: [
        "中東は、規制エコシステムの改善とヘルスケア近代化への強力な投資により、戦略的に重要な位置づけを維持しています。",
        "地域の調達モデルや流通エコシステムに合わせることで、必須治療への信頼できるアクセスを拡大しています。"
      ]
    },
    europe: {
      label: "ヨーロッパ",
      paragraphs: [
        "ヨーロッパは、質重視のエビデンスに基づくヘルスケア製品への強い需要を伴う、安定したコンプライアンスの高い市場を提供し続けています。",
        "当社の焦点は、長期的なパートナーシップ、供給の信頼性、そして成熟した成長回廊の両方における差別化されたポートフォリオのポジショニングにあります。"
      ]
    }
  }
},
...
"therapy": {
  ...
  "cardiology": {
    "title": "循環器学",
    "desc": "心臓の健康を守り向上させる先進的な心血管治療。"
  },
  "oncology": {
    "title": "腫瘍学",
    "desc": "標的治療に焦点を当てた革新的ながん治療。"
  },
  "neurology": {
    "title": "神経学",
    "desc": "神経系および認知機能のための革新的なソリューション。"
  },
  "endocrinology": {
    "title": "内分泌学",
    "desc": "専門的な処方によるホルモンバランスと代謝の健康。"
  },
  "dermatology": {
    "title": "皮膚科学",
    "desc": "革新と安全性を重視したスキンケア。"
  }
},
about: {
  video: {
...
leadership: {
  ...
  team: [
    { name: "Dr. Michael Carter", role: "首席科学官", quote: "科学与质量驱动每一个决策。" },
    { name: "James Wilson", role: "运营负责人", quote: "卓越运营确保稳定供应。" },
    { name: "Sophia Bennett", role: "质量总监", quote: "合规与一致性是核心。" },
    { name: "Daniel Hughes", role: "制造负责人", quote: "精密制造建立信任。" },
    { name: "Emily Parker", role: "法规事务", quote: "遵循全球标准。" },
    { name: "Oliver Reed", role: "供应链经理", quote: "物流稳定无延误。" },
    { name: "Ava Collins", role: "研发经理", quote: "持续创新。" },
    { name: "Ethan Brooks", role: "业务发展", quote: "合作推动增长。" },
    { name: "Mia Turner", role: "临床战略", quote: "以患者为中心。" },
    { name: "Henry Scott", role: "财务", quote: "可持续增长。" }
  ],
},
researchManufacturing: {
  ...
  research: {
    title: "研究開発",
    desc: "当社のR&Dチームは革新的な開発と品質向上に取り組んでいます。",
  },

  manufacturing: {
    title: "製造の卓越性",
    desc: "最新設備により高品質と安定供給を実現します。",
  },
...
ingredientFilters: {
  ...
  dosage: "形",
  sortBy: "並び替え",
  sortOptions: { nameAsc: "A-Z", nameDesc: "Z-A", category: "カテゴリ" },
  resetFilters: "リセット",
  results: "{{total}}結果",
  results_plural: "{{total}}結果"
},
ingredientGrid: {
  name: "名称",
  category: "カテゴリ",
...
productsPage: {
  heading: "製品一覧",
  subheading: "当社の医薬品ラインナップをご覧ください。",
  updating: "カタログを更新中...",
  search: "製品を検索...",
  category: "カテゴリー",
  form: "剤形",
...
otcPage: {
  ...
  features: {
    f1: { title: "科学", desc: "証拠ベース。" },
    f2: { title: "品質", desc: "高基準。" },
    f3: { title: "健康", desc: "日常用。" }
  },
...
aboutPage: {
  hero: {
    ...
    subtitle: "世界水準の製薬分野における卓越性と品質への揺るぎない取り組みにより、医療に革新をもたらします。"
  },
  stats: {
    years: "卓越性の年数",
    markets: "グローバル市場",
  ...
  story: {
    badge: "私たちの歩み",
    title: "2018年から製薬分野の卓越性を追求",
    p1: "Ivexia Pharmaは、品質、革新、そして世界の医療発展への強い commitment を基盤として築かれた先進的な製薬会社です。",
    p2: "創業以来、Ivexia Pharmaは国際基準を満たす信頼性の高い医薬品を提供し、医療提供者、販売業者、輸入業者、患者をさまざまな市場で支援することに注力してきました。",
    p3: "現在、Ivexia Pharmaは医薬品製造、製品開発、輸出供給、市場拡大における信頼できるパートナーです。"
  },
  purpose: {
    title: "私たちの目的",
    subtitle: "革新により推進され、誠実さにより導かれる",
    visionTitle: "私たちのビジョン",
    visionDesc: "品質、信頼性、革新、そして責任ある医療貢献で知られる世界的に認められた製薬会社となり、ヨーロッパ、MENA、アフリカ、CIS、東南アジア、その他成長する医療地域に貢献することを目指します。",
    missionTitle: "私たちの使命",
    missionDesc: "安全な製造、信頼できる輸出システム、強固な規制遵守、透明性のあるパートナーシップ、安定した供給支援を通じて、高品質な医薬品を世界市場に届けます。"
  },
  global: {
    badge: "グローバル展開",
    title: "世界規模の事業",
    subtitle: "世界市場に効率的に対応するための戦略的な拠点"
  },
  globalLocations: [
    {
      loc: "インド",
      desc: "最新の製造施設と研究開発センターを備えた戦略的な製薬拠点。"
    },
    {
      loc: "北マケドニア",
      desc: "EU市場に優れた品質で対応する、製造・流通の欧州ハブ。"
    },
    {
      loc: "カタール",
      desc: "MENA地域の本部として、中東全域で医療アクセスの拡大を推進。"
    }
  ],
  expertise: {
    badge: "事業内容",
    title: "専門分野",
    subtitle: "複雑な医療ニーズに対応する専門的な製薬ソリューション"
  },
  expertiseList: [
    {
      title: "研究開発",
      img: "/images/R&D.jpg",
      desc: "革新的な薬物送達システムに注力する先進的な研究施設。"
    },
    {
      title: "製造",
      img: "/images/Manufacturing.jpg",
      desc: "高度な製造能力を備えたWHO-GMP認定施設。"
    },
    {
      title: "オンコロジー",
      img: "/images/Oncology.jpg",
      desc: "患者自身の免疫システムががん細胞を認識し破壊することを支援する革新的な治療法。"
    }
  ],
  leadership: {
    badge: "リーダーシップ",
  ...
  timeline: {
    badge: "私たちの歩み",
    title: "成長のマイルストーン",
    subtitle: "製薬分野の卓越性へ向かう道のりにおける主な成果"
  },
  timelineList: [
    {
      year: "2018",
      event: "世界的な製薬分野の卓越性を目指すビジョンのもと会社を設立",
      icon: "Rocket"
    },
    {
      year: "2020",
      event: "初のWHO-GMP認定製造施設を設立",
      icon: "Industry"
    },
    {
      year: "2023",
    ...
    {
      year: "2025",
      event: "10以上の製品を備えたオンコロジー部門を開始",
      icon: "Microscope"
    },
    {
      year: "2030",
      event: "世界の製薬企業トップ50入りを目指すビジョン",
      icon: "Bullseye"
    }
  ],
  certifications: {
    badge: "品質保証",
    title: "グローバル認証",
    subtitle: "国際的な品質基準への適合"
  },
  statement: {
    title: "革新により推進され、品質により支えられる。",
    subtitle: "Ivexiaは製薬分野の進歩の最前線に立っています。"
  },
  facilities: {
    title: "最先端施設",
    subtitle: "世界的な規制基準を満たすよう設計されています。"
  },
  rnd: {
    badge: "イノベーション拠点",
    title: "研究開発",
    subtitle: "製薬研究の可能性を広げる"
  },
  labs: {
    title: "高度な研究開発施設",
    desc: "先進的な研究インフラと世界水準のGMP基準を備えています。"
  },
  sustainability: {
    badge: "環境",
    title: "持続可能性への取り組み",
    desc: "環境に配慮した製造と責任ある調達を重視しています。",
    points: [
      "ゼロ廃棄物製造への取り組み",
      "太陽光発電による施設運営",
      "持続可能な包装ソリューション"
  ...
  whoWeAre: {
    ...
    desc: "Ivexia Pharmaは、高品質な医薬品、製品開発支援、規制文書、包装ソリューション、そして医療販売業者、輸入業者、病院、製薬パートナー向けの信頼できる輸出供給を提供するグローバルな製薬メーカー兼輸出業者です。"
  },

  qualityInfo: {
    badge: "品質第一",
    title: "すべての中心にある品質",
    desc: "品質はIvexia Pharmaの基盤です。私たちのアプローチは、原材料評価、生産監視、工程内チェック、完成品試験、包装検査、文書レビュー、適切な保管管理を含みます。",
    points: [
      "GMPに準拠した製造基準",
      "検証済みの原材料調達",
      "ロットごとの品質管理試験",
  ...
  exportInfo: {
    badge: "グローバル輸出への注力",
    title: "信頼できる医薬品輸出供給",
    desc: "Ivexia Pharmaは、輸出準備が整った医薬品、適切な文書、包装支援、規制調整、市場志向の供給ソリューションを通じて、販売業者、輸入業者、医療企業、機関購入者を支援します。"
  },
  cta: {
    title: "私たちと提携しませんか",
    subtitle: "世界中に高品質な医療ソリューションを届けるために、私たちと共に歩みましょう。",
    button: "お問い合わせ"
  },
  detailedInfo: {
    badge: "Ivexia Pharmaについて",
    title: "2018年から製薬分野の卓越性を構築",
    sections: [
      {
        title: "私たちについて",
        desc: "Ivexia Pharmaは、規制市場および新興市場向けに幅広い医薬品を提供するグローバルな製薬メーカー兼輸出業者です。当社は、高品質な医薬品、最新のプロセス、強固な文書管理システム、厳格な品質チェックに重点を置いています。"
      },
      {
        title: "事業内容",
        desc: "私たちは、医薬品製造、輸出供給、製品開発、処方設計、規制文書、品質保証、品質管理、包装、ラベリング、受託製造、グローバル市場供給の調整を提供しています。"
      },
      {
        title: "規制対応力とコンプライアンス",
        desc: "Ivexia Pharmaは、規制要件、文書、製品ドシエ、COA支援、GMP関連文書、安定性データ、仕様、ラベリング、輸出文書に対して体系的なアプローチを取っています。"
      },
      {
        title: "革新と研究主導の成長",
        desc: "私たちは、実用的で市場志向の革新を通じて、処方、製造効率、製品安定性、包装品質、規制対応力の向上に注力しています。"
      },
      {
        title: "医療への取り組み",
        desc: "Ivexia Pharmaは、安全で信頼性が高く、手頃な価格の医薬品を責任、信頼、卓越性とともに提供することで、世界の医療に貢献することを約束します。"
      },
      {
        title: "未来を築く",
        desc: "Ivexia Pharmaは、グローバル展開、近代的な製造、製品多様化、そしてより強固な規制対応力を通じて前進しています。"
      }
    ]
  },
  ...
  faqs: [
    {
      ...
      answer: "Ivexia Pharmaは、医療販売業者、輸入業者、製薬パートナー向けに、高品質な医薬品、製品開発支援、輸出供給、規制文書、包装ソリューションを提供する製薬メーカー兼輸出業者です。"
    },
    {
      question: "Ivexia Pharmaはグローバルな製薬会社ですか？",
      answer: "はい。Ivexia Pharmaは国際的な製薬市場に注力しており、輸出準備が整った医薬品、品質文書、信頼できる供給ソリューションを通じて、世界の医療パートナーを支援しています。"
    },
    {
      question: "Ivexia Pharmaが信頼できる製薬パートナーである理由は何ですか？",
      answer: "Ivexia Pharmaは、高品質な製造、GMPに準拠したプロセス、規制支援、期限通りの納品、倫理的なビジネス慣行、長期的なパートナーシップ価値に注力しています。"
    },
    {
      question: "Ivexia Pharmaは医薬品輸出を支援していますか？",
      answer: "はい。Ivexia Pharmaは、製品供給、文書支援、包装支援、規制調整、市場志向の製薬ソリューションを通じて医薬品輸出を支援しています。"
    },
    {
      question: "Ivexia Pharmaはどの市場に対応していますか？",
      answer: "Ivexia Pharmaは、ヨーロッパ、MENA、アフリカ、CIS、東南アジア、その他成長する医療地域への対応を目指しています。"
    }
  ],
},
testKitDetailPage: {
