// //ivexia\components\IngredientStats.jsx
// "use client";
...
export default function IngredientStats() {
  ...
  const t = translations?.ingredientStats;

  const stats = [
    { target: 120, label: t?.products || "Products", suffix: "+" },
    { target: 15, label: t?.therapy || "Therapy Areas", suffix: "+" },
    { target: 30, label: t?.countries || "Countries Served", suffix: "+" },
    { target: 100, label: t?.documents || "Documents Available", suffix: "+" },
    { target: 8, label: t?.facilities || "Facilities" },
  ];
