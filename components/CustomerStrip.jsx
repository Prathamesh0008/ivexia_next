          ...
          <div className="partner-marquee-track p-10">
            {marqueePartners.map((partner, index) => (
              <a
                ...
                className="group partner-marquee-card rounded-[28px] border border-[#E2004F]/10 bg-[#fff8f4] px-2 py-2 md:px-3 md:py-3 shadow-sm hover:-translate-y-1 hover:shadow-md transition"
              >
