    ...
    <section className="bg-white py-20 px-6 md:px-16">
      ...
      <div className="text-center mb-14">
        <h2 className="text-3xl md:text-4xl font-bold text-[#0d2d47] mb-3">
          {translations?.latest?.heading}
        </h2>

        <p className="text-gray-600 max-w-2xl mx-auto text-sm md:text-base">
          {translations?.latest?.subheading}
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        {newsPosts.map((post, index) => {
          ...
          const postData = translations?.news?.posts?.[post.slug];
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between text-sm text-gray-500">
                  ...
                  >
                    {translations?.latest?.readMore} <ArrowRight size={14} />
                  </button>
                </div>
              </div>
            </motion.div>
...
// //ivexia\components\LatestFromIvexia.jsx
// "use client";
