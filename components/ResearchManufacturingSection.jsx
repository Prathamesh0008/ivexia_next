...
export default function ResearchManufacturingSection() {
  ...
  const tabs = [
    { key: "research", label: translations?.researchManufacturing?.tabs?.research },
    { key: "manufacturing", label: translations?.researchManufacturing?.tabs?.manufacturing },
  ];

  const content = {
    research: {
      title: translations?.researchManufacturing?.research?.title,
      desc: translations?.researchManufacturing?.research?.desc,
    ...
    manufacturing: {
      title: translations?.researchManufacturing?.manufacturing?.title,
      desc: translations?.researchManufacturing?.manufacturing?.desc,
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div>
            ...
            >
              {translations?.researchManufacturing?.button}
            </Link>
          </div>
...
// //ivexia\components\ResearchManufacturingSection.jsx
// "use client";
